...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    <title>Odd Job :: Merchant Signup</title>
	...
	<body><div id="divMainWrapper" align="center">
		<div id="divLogin"><a href="login.php?t=merchant">Already have an account?</a></div>
		<form id="frmSignup" name="frmSignup" method="post" action="./signup.php"><table id="tblFormTout" cellpadding="0" cellspacing="0" border="0">
			<tr><td colspan="2" id="tdFormHeader">Merchant Signup</td></tr>
			...
			<tr><td colspan="2" align="center"><input type="hidden" id="hidPhone" name="hidPhone" value="" /><input type="hidden" id="hidType" name="hidType" value="merchant" /><input type="button" id="btnSubmit" name="btnSubmit" value="Submit" onclick="signup();"></td></tr>
